    ...
    font-size: 2rem;">TEST</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <!-- <li class="nav-item">
                        <a id="nav-link" class="nav-link active" aria-current="page" href="<?php echo base_url(); ?>/home"><b>หน้าเเรก</b></a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link active" aria-current="page" href="#"><b>หน้าสอง</b></a>
                    </li> -->
                </ul>
                <?php if (isset($_SESSION['user_role']) && $_SESSION["user_role"] == "1") { ?>
                    <form class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <a class="btn btn-success" aria-current="page" href="<?php echo base_url(); ?>/logout"><b>ออกจากระบบ</b></a>
                        </li>
                    </form>
                <?php } else if (isset($_SESSION['user_role']) && $_SESSION["user_role"] == "0") { ?>
                    <form class="navbar-nav">
                        <li class="nav-item">
                            <a style="color:white"><b>คุณ : <?php echo $session->get('user_firstname'); ?> <?php echo $session->get('user_lastname'); ?></b></a>
                            <a class="btn btn-success" aria-current="page" href="<?php echo base_url(); ?>/logout"><b>ออกจากระบบ</b></a>
                        </li>
                    </form>
                <?php } else { ?>
                    <form class="navbar-nav">
                        <li class="nav-item">
                            <a id="" class="btn btn-success" aria-current="page" href="<?php echo base_url(); ?>/signin"><b>เข้าสู่ระบบ</b></a>
                        </li>
                    </form>
                <?php } ?>
            </div>
